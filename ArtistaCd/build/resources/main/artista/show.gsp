...
<html>
    ...
    <body>
        ...
        <div id="show-artista" class="content scaffold-show" role="main">
            ...
            <f:display bean="artista" />
            <g:form resource="${this.artista}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.artista}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
